...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button resbtn = (Button) findViewById(R.id.restartBtn);
        ...
        toggle.syncState();//该方法会自动和toolbar关联, 将开关的图片显示在了action上，如果不设置，也可以有抽屉的效果，不过是默认的图标
        ...
        tipbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                GameView.getGameView().getTip();
                Log.i("MainAcitivity", "onClick: tipbtn");
            }
        });
