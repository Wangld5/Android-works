...
public class bilibiliActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bilibili_main);
        findView();
        list = new ArrayList<RecyclerObj>();
        recycleAdapter = new RecycleAdapter(list, bilibiliActivity.this);
        rv.setAdapter(recycleAdapter);
        rv.setLayoutManager(new LinearLayoutManager(bilibiliActivity.this));
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!pattern.matcher(userID).matches()){
                    Toast.makeText(bilibiliActivity.this, "需要整数数据类型", Toast.LENGTH_SHORT).show();
                }
                else if (!isNetworkConnected(bilibiliActivity.this)){
